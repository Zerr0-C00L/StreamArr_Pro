...
func (s *SettingsStore) mapToResponse(m map[string]string) *models.SettingsResponse {
	...
	return &models.SettingsResponse{
		...
		MaxResolution:                getInt("max_resolution", 1080),
		MaxFileSize:                  getInt("max_file_size", 50000),
		...
		EnableReleaseFilters:         getBool("enable_release_filters"),
		ExcludedReleaseGroups:        getString("excluded_release_groups"),
		ExcludedLanguages:            getString("excluded_languages"),
		ExcludedQualities:            getString("excluded_qualities"),
...
func (s *SettingsStore) responseToMap(r *models.SettingsResponse) map[string]string {
	return map[string]string{
		...
		"max_resolution":                 fmt.Sprintf("%d", r.MaxResolution),
		"max_file_size":                  fmt.Sprintf("%d", r.MaxFileSize),
		...
		"enable_release_filters":         fmt.Sprintf("%t", r.EnableReleaseFilters),
		"excluded_release_groups":        r.ExcludedReleaseGroups,
		"excluded_languages":             r.ExcludedLanguages,
		"excluded_qualities":             r.ExcludedQualities,
